...
class FourElements
{
    ...
    public function getFourElements($number = 5): array
    {
        $res = [];
        for ($i = 1; $i <= $number; $i++) {
     ...
     * @return mixed
     */
    protected function generateValidateCode($number)
    {
    ...
    protected function getCertNo(): string
    {
        $areaCode = [
            ['110000', '北京市'],
            ['110101', '东城区'],
        ...
        return $certNo . $this->generateValidateCode($certNo);
    }
